...
def login_page():
    ...
    with col2:
        ...
        with tab1:
            ...
            with col_a:
                if st.button("🍎 Sign in with Apple", use_container_width=True, key="apple_signin"):
                    st.info("🔄 Apple Sign In coming soon! Enable in config/auth_keys.env")
            with col_b:
                if st.button("🔵 Sign in with Google", use_container_width=True, key="google_signin"):
                    st.info("🔄 Google Sign In coming soon! Enable in config/auth_keys.env")
            
            if st.button("😺 Sign in with GitHub", use_container_width=True, key="github_signin"):
        ...
        with tab2:
            ...
            col_a, col_b = st.columns(2)
            with col_a:
                if st.button("🍎 Sign up with Apple", use_container_width=True, key="apple_signup"):
