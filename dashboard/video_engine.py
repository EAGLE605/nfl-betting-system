...
def generate_slide(slide_type, game_data, filename, width=1920, height=1080):
    ...
    if slide_type == "title":
        ...
        draw.text((width//2 - 200, 100), "GAMELOCK AI", font=font_medium, fill="#22c55e")
        draw.text((width//2 - 350, 250), "DEEP DIVE", font=font_large, fill="#ffffff")
        
        # Matchup
        draw.rectangle([(100, 450), (width-100, 650)], fill=primary, outline="#ffffff", width=3)
        matchup_text = game_data['matchup']
        draw.text((width//2 - len(matchup_text)*20, 500), matchup_text, font=font_medium, fill="#ffffff")
        
        # Subtitle
        draw.text((width//2 - 300, 750), "AI-POWERED ANALYSIS", font=font_small, fill="#94a3b8")
        ...
        draw.rectangle([(200, 300), (width-200, 550)], fill=primary, outline="#22c55e", width=5)
        draw.text((width//2 - len(bet_text)*30, 370), bet_text, font=font_large, fill="#ffffff")
        ...
        # Sharp indicator
        draw.text((width//2 - 200, 800), "SHARP MONEY APPROVED", font=font_small, fill="#f59e0b")
        
    elif slide_type == "confidence":
        # SLIDE 3: Confidence/Lock
        draw.text((width//2 - 200, 100), "CONFIDENCE", font=font_medium, fill="#22c55e")
        ...
        draw.rectangle([(200, 550), (width-200, 620)], fill="#1f2937", outline="#374151", width=2)
        draw.rectangle([(200, 550), (200 + bar_width, 620)], fill="#22c55e")
        
        # Lock text
        draw.rectangle([(width//2 - 200, 700), (width//2 + 200, 800)], fill="#22c55e")
        draw.text((width//2 - 100, 720), "LOCKED IN", font=font_small, fill="#000000")
        
        # Footer
        draw.text((width//2 - 150, 900), "GAMELOCK AI", font=font_small, fill="#64748b")
