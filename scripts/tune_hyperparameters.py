...
def load_data(seasons_train: list, seasons_val: list):
    ...
    logger.info(f"Loading features for training: {seasons_train}, validation: {seasons_val}")
...
def main():
    ...
    parser.add_argument("--model", type=str, choices=["xgboost", "lightgbm", "both"],
                       default="both", help="Model to tune")
    parser.add_argument("--trials", type=int, default=200, help="Number of Optuna trials")
    parser.add_argument("--train-seasons", type=str, default="2016-2022",
                       help="Training seasons (e.g., 2016-2022)")
    parser.add_argument("--val-seasons", type=str, default="2023",
    ...
    # Parse seasons
    train_seasons = list(range(int(args.train_seasons.split("-")[0]),
