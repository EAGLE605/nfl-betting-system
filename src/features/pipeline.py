...
class FeaturePipeline:
    ...
    def _validate_features(self, df: pd.DataFrame):
        ...
        exclude = ['game_id', 'gameday', 'home_team', 'away_team',
        ...
        if len(numeric_cols) > 1:
            ...
            if high_corr:
                logger.warning(f"High correlations found (>0.85):")
...
def create_features(seasons: List[int], output_path: Optional[str] = None) -> pd.DataFrame:
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=str,
                        default='data/processed/features_2016_2024.parquet')
