...
class SMSSender:
    ...
    def __init__(
        self, account_sid: str, auth_token: str, from_phone: str, to_phone: str
    ):
        """
    ...
    def send_quick_alert(self, analysis: Dict, parlays: Dict) -> bool:
        ...
        try:
            ...
            ev_str = (
                f"{top_bet['expected_value']:+.0%}"
                if top_bet["expected_value"]
                else "N/A"
            )
            ...
            self.client.messages.create(
                body=message, from_=self.from_phone, to=self.to_phone
            )
